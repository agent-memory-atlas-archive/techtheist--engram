...
use engram_eval::generate::{Corpus, Fact, KINDS, Kind, Phrasing, corpus_chained};
use engram_eval::profile::Profile;
use engram_eval::rng::Rng;
...
pub fn build(cfg: &WorldConfig) -> Script {
    let base = engram_core::parse_day(BASE_DAY).expect("BASE_DAY parses");
